...
sct.connect(("192.168.0.96", 30002))
sct.send("""def unnamed():
  ...
  # end: URCap Installation Node
  step_count_c9f4858a_f319_4f1f_8425_cc9945655100 = 0.0
  thread Step_Counter_Thread_74fab2ee_3d78_4421_86ae_b7094c4e2289():
    while (True):
      step_count_c9f4858a_f319_4f1f_8425_cc9945655100 = step_count_c9f4858a_f319_4f1f_8425_cc9945655100 + 1.0
      sync()
    end
  end
  run Step_Counter_Thread_74fab2ee_3d78_4421_86ae_b7094c4e2289()
  global Waypoint_1_p=p[-.018350707297, -.300968239274, .325227276476, -.010510528358, 3.137781561353, -.130954426996]
  global Waypoint_1_q=[-1.1552813688861292, -1.6983314953246058, -0.546204149723053, -2.3899413547911585, 1.533625841140747, 0.4106970429420471]
  while (True):
    $ 2 "Robot Program"
    $ 3 "MoveJ"
